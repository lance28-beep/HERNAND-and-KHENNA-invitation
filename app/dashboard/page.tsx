...
export default function DashboardPage() {
  ...
  const DASHBOARD_PASSWORD = "212026" // Change this to your preferred password
        ...
        <div className="w-full max-w-md">
          <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-[#3C3C3C]/10">
            <div className="text-center mb-8">
              ...
              <div className="text-xs tracking-[0.25em] uppercase font-[family-name:var(--font-crimson)] font-semibold text-[#3C3C3C]/60 mb-2">Welcome 
              Steven & Renee</div>
