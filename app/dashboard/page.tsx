...
export default function DashboardPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-[#FFE4E4] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-[#8C8E7C]/20">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-[#8C8E7C]/10 rounded-full mb-4">
                <Lock className="h-10 w-10 text-[#676B57]" />
              </div>
              <div className="text-xs tracking-[0.25em] uppercase font-[family-name:var(--font-crimson)] font-semibold text-[#676B57]/60 mb-2">Welcome 
              {siteConfig.couple.groomNickname} & {siteConfig.couple.brideNickname}</div>
              <h1 className="text-3xl font-[family-name:var(--font-crimson)] font-bold text-[#676B57] mb-2">
                Wedding Dashboard
              </h1>
              <p className="text-[#676B57]/60 font-sans text-sm">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#676B57] mb-2 font-sans">
                  Password
                </label>
                <input
                  type="password"
                  ...
                  className="w-full px-4 py-3 border border-[#8C8E7C]/20 focus:border-[#676B57] rounded-xl font-sans placeholder:text-[#676B57]/40 transition-all duration-300 focus:ring-2 focus:ring-[#676B57]/10 bg-white"
                  autoFocus
                />
              </div>

              {error && (
                <div className="bg-[#8C8E7C]/10 border border-[#676B57]/30 rounded-xl p-3 flex items-center gap-2">
                  <AlertCircle className="h-5 w-5 text-[#676B57]" />
                  <span className="text-[#676B57] font-semibold text-sm">{error}</span>
                </div>
              )}

              <Button
                type="submit"
                className="w-full bg-[#676B57] hover:bg-[#676B57]/90 text-[#FFE4E4] py-3 rounded-xl font-semibold transition-all duration-300"
              >
                Access Dashboard
              </Button>
            </form>
  ...
  return (
    <div className="min-h-screen bg-[#FFE4E4]">
      {/* Header */}
      <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-[#8C8E7C]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-[family-name:var(--font-crimson)] font-bold text-[#676B57]">Wedding Dashboard</h1>
              <p className="text-[#676B57]/60 text-sm font-sans">Manage your guest list and RSVPs</p>
            </div>
            <div className="flex items-center gap-3">
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-[#8C8E7C]/20 text-[#676B57] hover:bg-[#8C8E7C]/10"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#8C8E7C]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Users className="h-6 w-6 sm:h-8 sm:w-8 text-[#676B57]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#676B57]">{stats.totalGuests}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Total Guests</p>
            <p className="text-xs text-[#676B57]/50 font-sans mt-1">{stats.total} entries</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#B18B81]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#B18B81]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#B18B81]">{stats.attending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Attending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#676B57]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <XCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#676B57]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#676B57]">{stats.notAttending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Not Attending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#EFC0BC]/30 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <AlertCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#EFC0BC]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#EFC0BC]">{stats.pending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Pending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#EFC0BC]/30 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Bell className="h-6 w-6 sm:h-8 sm:w-8 text-[#EFC0BC]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#EFC0BC]">{guestRequests.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Requests</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#B18B81]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Crown className="h-6 w-6 sm:h-8 sm:w-8 text-[#B18B81]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#B18B81]">{entourage.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Entourage</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#8C8E7C]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <UserPlus className="h-6 w-6 sm:h-8 sm:w-8 text-[#676B57]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#676B57]">{principalSponsors.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#676B57]/70 font-sans">Principal Sponsors</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="bg-white/90 rounded-2xl p-1 sm:p-2 shadow-sm border border-[#8C8E7C]/20 mb-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2">
            <button
              ...
              className={`w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 ${
                activeTab === "guests"
                  ? "bg-[#676B57] text-[#FFE4E4] shadow-md"
                  : "text-[#676B57] hover:bg-[#8C8E7C]/10"
              }`}
            >
            ...
            >
              ...
              {guestRequests.length > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#EFC0BC] text-[#FFE4E4] text-[10px] sm:text-xs font-bold rounded-full min-w-[18px] h-4 sm:min-w-[20px] sm:h-5 px-1 flex items-center justify-center">
        ...
        <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#8C8E7C]/20 mb-6">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
            <div className="flex-1 w-full">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#676B57]/40" />
                <input
                  type="text"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search guests by name or email..."
                  className="w-full pl-10 pr-4 py-2 border border-[#676B57]/20 focus:border-[#676B57] rounded-xl font-sans placeholder:text-[#676B57]/40 transition-all duration-300 focus:ring-2 focus:ring-[#676B57]/10 bg-white"
                />
              </div>
            </div>
              <Button
              ...
              className="bg-[#676B57] hover:bg-[#676B57]/90 text-[#FFE4E4] transition-all duration-300"
            >
          ...
          {successMessage && (
            <div className="bg-[#B18B81]/10 border border-[#B18B81]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
              <CheckCircle className="h-5 w-5 text-[#B18B81]" />
              <span className="text-[#B18B81] font-semibold text-sm">{successMessage}</span>
            </div>
          )}

          {error && (
            <div className="bg-[#8C8E7C]/10 border border-[#676B57]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
              <AlertCircle className="h-5 w-5 text-[#676B57]" />
              <span className="text-[#676B57] font-semibold text-sm">{error}</span>
            </div>
          )}
        ...
        {/* Guest List */}
        <div className="bg-white/90 rounded-2xl shadow-sm border border-[#8C8E7C]/20 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#8C8E7C]/10">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Name</th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Email</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">RSVP</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)] whitespace-nowrap">
                    <span className="flex items-center justify-center gap-1">
                      <Users className="h-4 w-4" />
                      Guests
                    </span>
                  </th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Message</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#8C8E7C]/20">
                {filteredGuests.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-[#676B57]/60 font-sans">
                      {isLoading ? (
                        <div className="flex items-center justify-center gap-2">
                          <RefreshCw className="h-5 w-5 animate-spin text-[#676B57]" />
                  ...
                  filteredGuests.map((guest, index) => (
                    <tr key={index} className="hover:bg-[#8C8E7C]/10 transition-colors">
                      <td className="px-6 py-4 font-medium text-[#676B57] font-sans">{guest.Name}</td>
                      <td className="px-6 py-4 text-[#676B57]/70 font-sans">
                        {guest.Email && guest.Email !== "Pending" ? guest.Email : "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        {guest.RSVP === "Yes" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#B18B81]/20 text-[#B18B81] rounded-full text-sm font-semibold">
                            <CheckCircle className="h-4 w-4" />
                            Attending
                          </span>
                        )}
                        {guest.RSVP === "No" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#676B57]/20 text-[#676B57] rounded-full text-sm font-semibold">
                            <XCircle className="h-4 w-4" />
                            Not Attending
                          </span>
                        )}
                        {guest.RSVP === "Maybe" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#EFC0BC]/20 text-[#EFC0BC] rounded-full text-sm font-semibold">
                            <AlertCircle className="h-4 w-4" />
                            Maybe
                          </span>
                        )}
                        {!guest.RSVP || guest.RSVP.trim() === "" ? (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#8C8E7C]/10 text-[#676B57]/70 rounded-full text-sm font-semibold">
                            Pending
                          </span>
                        ) : null}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center px-3 py-1.5 bg-[#B18B81]/20 text-[#B18B81] rounded-full text-sm font-bold min-w-[3.5rem] border border-[#B18B81]/30">
                          {guest?.Guest !== undefined && guest?.Guest !== null && guest?.Guest !== '' 
                            ? (parseInt(String(guest.Guest)) || 1) 
                            : 1}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-[#676B57]/70 font-sans max-w-xs truncate" title={guest.Message || ""}>
                        {guest.Message || "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-2 text-[#676B57] hover:bg-[#8C8E7C]/10 rounded-lg transition-colors"
                            title="Edit guest"
                          >
                ...
                <table className="w-full">
                  <thead className="bg-[#8C8E7C]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Email</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Phone</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)] whitespace-nowrap">
                        <span className="flex items-center justify-center gap-1">
                          <Users className="h-4 w-4" />
                          Guests
                  ...
                  <tbody className="divide-y divide-[#8C8E7C]/20">
                    {filteredRequests.length === 0 ? (
                      ...
                      filteredRequests.map((request, index) => (
                        <tr key={index} className="hover:bg-[#8C8E7C]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#676B57] font-sans">{request.Name}</td>
                          <td className="px-6 py-4 text-[#676B57]/70 font-sans">
                          ...
                          <td className="px-6 py-4 text-[#676B57]/70 font-sans max-w-xs truncate">
                            {request.Message || "-"}
                          </td>
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="px-4 py-2 bg-[#676B57] hover:bg-[#676B57]/90 text-[#FFE4E4] rounded-lg transition-colors font-semibold text-sm flex items-center gap-2 shadow-sm hover:shadow-md"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#8C8E7C]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Role Category</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Role Title</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Email</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#8C8E7C]/20">
                    {filteredEntourage.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center text-[#676B57]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#676B57]" />
                      ...
                      filteredEntourage.map((member, index) => (
                        <tr key={index} className="hover:bg-[#8C8E7C]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#676B57] font-sans">{member.Name}</td>
                          <td className="px-6 py-4 text-[#676B57]/70 font-sans">
                            {member.RoleCategory || "-"}
                          </td>
                          <td className="px-6 py-4 text-[#676B57]/70 font-sans">
            ...
            <div className="bg-white/90 rounded-2xl shadow-sm border border-[#8C8E7C]/20 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#8C8E7C]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Male Principal Sponsor</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Female Principal Sponsor</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#8C8E7C]/20">
                    {filteredPrincipalSponsors.length === 0 ? (
                      <tr>
                        <td colSpan={3} className="px-6 py-12 text-center text-[#676B57]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#676B57]" />
                      ...
                      filteredPrincipalSponsors.map((sponsor, index) => (
                        <tr key={index} className="hover:bg-[#8C8E7C]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#676B57] font-sans">{sponsor.MalePrincipalSponsor}</td>
                          <td className="px-6 py-4 text-[#676B57]/70 font-sans">
...
function AddToGuestListModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#8C8E7C]/20">
        <div className="sticky top-0 bg-[#8C8E7C]/10 px-6 py-4 border-b border-[#8C8E7C]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Add to Guest List</h3>
            <button
              onClick={onCancel}
              className="p-2 hover:bg-[#8C8E7C]/10 rounded-lg transition-colors text-[#676B57]/70 hover:text-[#676B57]"
            >
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-base text-[#676B57] font-sans leading-relaxed">
              <span className="font-bold text-lg">{request.Name}</span> is requesting to join your wedding with a total of{" "}
              <span className="font-bold text-lg text-[#B18B81]">{guestCount}</span>{" "}
              {guestCount === 1 ? "guest" : "guests"}.
            </p>
          </div>
          
          <div className="bg-[#B18B81]/5 rounded-xl p-4 mb-6 border border-[#B18B81]/20">
            <p className="text-sm font-semibold text-[#676B57] mb-2 font-sans">Request Details:</p>
            <div className="space-y-2 text-sm text-[#676B57]/80 font-sans">
              ...
              {request.Message && (
                <div className="mt-2 pt-2 border-t border-[#B18B81]/20">
          ...
          <p className="text-sm text-[#676B57]/70 mb-6 font-sans">
          ...
          <div className="flex gap-3">
            <Button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 bg-[#676B57] hover:bg-[#676B57]/90 text-[#FFE4E4] disabled:opacity-50"
            >
              {isLoading ? (
                <>
            ...
            <Button onClick={onCancel} variant="outline" className="px-6 border-[#676B57]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
...
function EntourageModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-[#8C8E7C]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#8C8E7C]/10 px-6 py-4 border-b border-[#8C8E7C]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">{editing ? 'Edit Entourage Member' : 'Add New Entourage Member'}</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#8C8E7C]/10 rounded-lg transition-colors text-[#676B57]/70 hover:text-[#676B57]"
            >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[#676B57] mb-2 font-sans">Name *</label>
              <input
                type="text"
                value={formData.Name}
            ...
            <div>
              <label className="block text-sm font-medium text-[#676B57] mb-2 font-sans">Email</label>
              <input
                type="email"
          ...
          <div className="flex gap-3 mt-6">
            <Button
              onClick={onSave}
              disabled={isLoading}
              className="flex-1 bg-[#676B57] hover:bg-[#676B57]/90 text-[#FFE4E4]"
            >
              {isLoading ? (
                <>
                  <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#676B57]/20">Cancel</Button>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-[#8C8E7C]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#8C8E7C]/10 px-6 py-4 border-b border-[#8C8E7C]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#676B57]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#8C8E7C]/20">
        <div className="sticky top-0 bg-[#8C8E7C]/10 px-6 py-4 border-b border-[#8C8E7C]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Add New Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#8C8E7C]/10 rounded-lg transition-colors text-[#676B57]/70 hover:text-[#676B57]"
            >
        ...
        <div className="p-6">
          <p className="text-sm text-[#676B57]/70 mb-4 font-sans leading-relaxed">
          ...
          <div>
            ...
            <input
              ...
              value={formData.Name}
              onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
              className="w-full px-4 py-3 border border-[#676B57]/20 focus:border-[#676B57] rounded-xl text-sm font-sans placeholder:text-[#676B57]/40 transition-all duration-300 focus:ring-2 focus:ring-[#676B57]/10 bg-white"
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#676B57]/20">
              Cancel
            </Button>
          </div>
        </div>
...
function EditGuestModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-[#8C8E7C]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#8C8E7C]/10 px-6 py-4 border-b border-[#8C8E7C]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">Edit Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#8C8E7C]/10 rounded-lg transition-colors text-[#676B57]/70 hover:text-[#676B57]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-[#676B57]/20 focus:border-[#676B57] rounded-xl text-sm font-sans bg-white transition-all duration-300 focus:ring-2 focus:ring-[#676B57]/10"
                required
              >
...
function ConfirmModal({ open, title, message, onCancel, onConfirm }: { open: boolean; title: string; message: string; onCancel: () => void; onConfirm: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-[#8C8E7C]/20">
        <div className="px-5 py-4 border-b border-[#8C8E7C]/20 bg-[#8C8E7C]/10 rounded-t-2xl">
          <h3 className="text-base sm:text-lg font-bold text-[#676B57] font-[family-name:var(--font-crimson)]">{title}</h3>
        </div>
        <div className="px-5 py-4 text-sm sm:text-base text-[#676B57]/80 font-sans">
          {message}
        </div>
        <div className="px-5 py-4 flex justify-end gap-2 border-t border-[#8C8E7C]/20">
          <button onClick={onCancel} className="px-4 py-2 text-sm rounded-lg border border-[#676B57]/20 text-[#676B57] hover:bg-[#8C8E7C]/10 transition-colors font-sans">Cancel</button>
          <button onClick={onConfirm} className="px-4 py-2 text-sm rounded-lg bg-[#676B57] text-[#FFE4E4] hover:bg-[#676B57]/90 transition-colors font-sans">Delete</button>
        </div>
      </div>
    </div>
  )
