    ...
    return (
      ...
      >
        ...
        {showRole && member.RoleTitle && (
          <p
            className={`text-[#676B57]/60 text-[10px] sm:text-xs md:text-sm font-[family-name:var(--font-crimson)] font-normal mt-0.5 sm:mt-1 leading-tight sm:leading-snug ${textAlign}`}
          >
            {member.RoleTitle}
          </p>
        )}
              ...
              {isLoading ? (
                <div className="flex items-center justify-center py-12 sm:py-16 md:py-24">
                  <div className="flex flex-col items-center gap-3 sm:gap-4">
                    <Loader2 className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 animate-spin text-[#676B57]" />
                    <span className="text-[#676B57]/70 font-[family-name:var(--font-crimson)] text-sm sm:text-base md:text-lg">
                      Loading entourage...
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center py-12 sm:py-16 md:py-24">
                  <div className="text-center">
                    ...
                    <button
                      ...
                      className="text-[#676B57] hover:text-[#676B57]/70 font-[family-name:var(--font-crimson)] underline transition-colors duration-300 text-sm sm:text-base"
                    >
                      Try again
                    </button>
                  </div>
                ...
                <div className="text-center py-12 sm:py-16 md:py-24">
                  <Users className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 text-[#676B57]/30 mx-auto mb-3 sm:mb-4" />
                  <p className="text-[#676B57]/70 font-[family-name:var(--font-crimson)] text-sm sm:text-base md:text-lg">
                        ...
                        <div key={category}>
                          {categoryIndex > 0 && (
                            <div className="flex items-center justify-center gap-3 sm:gap-4 py-4 sm:py-5 mb-6 sm:mb-7 md:mb-9">
                              <div className="h-px w-12 sm:w-16 md:w-20 bg-[#676B57]/40" />
                              <div className="w-1.5 h-1.5 bg-[#676B57]/50 rounded-full" />
                              <div className="h-px w-12 sm:w-16 md:w-20 bg-[#676B57]/40" />
                            </div>
                          )}
                          <TwoColumnLayout
                      ...
                      <div key={category}>
                        {categoryIndex > 0 && (
                          <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 py-2 sm:py-3 md:py-4 mb-3 sm:mb-5 md:mb-7">
                            <div className="h-px w-8 sm:w-12 md:w-16 bg-[#676B57]/40" />
                            <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-[#676B57]/50 rounded-full" />
                            <div className="h-px w-8 sm:w-12 md:w-16 bg-[#676B57]/40" />
                          </div>
                        )}
                        <TwoColumnLayout
